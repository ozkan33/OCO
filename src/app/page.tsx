        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
          // 1. Organization + LocalBusiness (dual-type for max coverage)
          {
            ...
            sameAs: [
              ...
              'https://www.facebook.com/share/1CMhWEhQaG/?mibextid=wwXIfr',
          ...
          {sent ? (
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                <a
                  href="https://www.facebook.com/share/1CMhWEhQaG/?mibextid=wwXIfr"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow us on Facebook"
                  className="group inline-flex items-center gap-2 pl-3 pr-4 py-2.5 rounded-lg border border-slate-200 bg-white hover:border-transparent hover:bg-[#1877F2] text-slate-700 hover:text-white transition-all"
                >
                  <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="Follow us on Facebook"
                    className="group inline-flex items-center gap-2 pl-2 pr-3 py-2 rounded-lg bg-slate-800/60 border border-slate-800 hover:border-transparent hover:bg-[#1877F2] transition-all duration-200"
                  >
                    <svg className="w-[18px] h-[18px] text-slate-400 group-hover:text-white transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                    <span className="text-xs font-medium text-slate-300 group-hover:text-white transition-colors duration-200">Facebook</span>
                  </a>
                  {/* LinkedIn */}
                  <a
                    href="https://www.linkedin.com/company/3brothersmarketing"
